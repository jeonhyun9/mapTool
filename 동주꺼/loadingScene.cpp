...
void loadingScene::loadingImage()
{
	...
	_loading->loadFrameImage("보스", "images/보스", 544, 256, 4, 2);
	_loading->loadFrameImage("보스공격", "images/보스공격", 160, 48, 2, 2);
	_loading->loadFrameImage("초록거북", "images/초록거북", 192, 192, 3, 2);
	_loading->loadFrameImage("파란거북", "images/파란거북", 192, 192, 3, 2);
	_loading->loadFrameImage("날개거북", "images/날개거북", 128, 128, 2, 2);
	_loading->loadFrameImage("도치", "images/도치",128,128,2,2);
	_loading->loadFrameImage("버섯", "images/버섯", 64, 64, 2, 1);
	_loading->loadFrameImage("초록꽃", "images/초록꽃", 128, 96, 2, 1);
	_loading->loadFrameImage("파란꽃", "images/파란꽃", 128, 96, 2, 1);
	_loading->loadFrameImage("회색새", "images/회색새", 64, 64, 2, 2);
	_loading->loadFrameImage("초록새", "images/회색새", 64, 64, 2, 2);
	_loading->loadFrameImage("빨간새", "images/회색새", 64, 64, 2, 2);
	_loading->loadFrameImage("회색콩벌레", "images/회색콩벌레", 64, 64, 2, 2);
	_loading->loadFrameImage("파란콩벌레", "images/파란콩벌레", 64, 64, 2, 2);
	_loading->loadFrameImage("검은콩벌레", "images/검은콩벌레", 64, 64, 2, 2);
	_loading->loadImage("왼쪽폭탄", "images/왼쪽폭탄", 64, 64);
	_loading->loadImage("오른쪽폭탄", "images/오른쪽폭탄", 64, 64);
	_loading->loadImage("포탑", "images/포탑", 64, 128);
