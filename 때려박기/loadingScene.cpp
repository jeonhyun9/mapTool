...
void loadingScene::loadingImage()
{
	...
	_loading->loadFrameImage("회색새", "images/초록새.bmp", 128, 128, 2, 2);
	_loading->loadFrameImage("초록새", "images/빨간새.bmp", 128, 128, 2, 2);
	_loading->loadFrameImage("빨간새", "images/회색새.bmp", 128, 128, 2, 2);
	_loading->loadFrameImage("회색콩벌레", "images/회색콩벌레.bmp", 128, 128, 2, 2);
	_loading->loadFrameImage("파란콩벌레", "images/파란콩벌레.bmp", 128, 128, 2, 2);
	_loading->loadFrameImage("검은콩벌레", "images/검은콩벌레.bmp", 128, 128, 2, 2);
	...
	_loading->loadFrameImage("마리오_IDLE", "images/마리오_IDLE.bmp", 300,160,5,2);
